...
export default function About() {
  return <div className="editorial-page">
    <header className="editorial-hero section-pad"><p className="eyebrow">About the studio</p><h1>Designing with<br /><em>intention.</em></h1><p className="editorial-lead">Ahsan Aziz is an architect based in I-14/3, Islamabad, working across architecture, interiors and visualization.</p></header>
